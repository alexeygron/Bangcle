...
//		String apkName="com.aispeech.weiyu_2.apk";
        ...
        try {
            ...
            SystemCommand.execute("java -jar tools/apktool.jar --use-aapt2 d " + apkPath + " -o " + decompiledFile.getAbsolutePath() + " -s -f");
        ...
        if (decompiled) {
            if (alterAndroidMainifest(decompiledFile.getAbsolutePath())) {
                ...
                try {
                    ...
                    SystemCommand.execute("java -jar tools/apktool.jar --use-aapt2 b "
